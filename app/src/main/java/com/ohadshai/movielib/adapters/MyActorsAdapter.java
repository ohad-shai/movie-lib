...
/**
 * Represents an actors adapter for RecyclerView.
 * Created by Ohad on 03/20/2017.
 */
public class MyActorsAdapter extends RecyclerView.Adapter<MyActorsAdapter.ViewHolder> {
    ...
    /**
     * Holds the list of actors to adapt.
     */
    private ArrayList<Person> _actors;
    ...
    /**
     * Initializes a new instance of an actors adapter for RecyclerView.
     *
     * @param actors   The list of actors to adapt.
     * @param fragment The fragment owner of the adapter.
     */
    public MyActorsAdapter(ArrayList<Person> actors, Fragment fragment) {
        this._actors = actors;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        viewHolder.bindViewHolder(_actors.get(position)); // Gets the _person by the position, and binds it to the view holder.
    }
