...
/**
 * Represents the "Search Movies" adapter for RecyclerView.
 * Created by Ohad on 03/25/2017.
 */
public class SearchMoviesAdapter extends RecyclerView.Adapter<SearchMoviesAdapter.ViewHolder> {
    ...
    /**
     * Initializes a new instance of the "Search Movies" adapter for RecyclerView.
     *
