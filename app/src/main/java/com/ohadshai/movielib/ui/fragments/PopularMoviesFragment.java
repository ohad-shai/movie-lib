...
import com.ohadshai.movielib.loaders.PopularMoviesLoader;
...
/**
 * A simple {@link Fragment} subclass for "Popular Movies".
 */
public class PopularMoviesFragment extends Fragment implements SelectionHelper.SelectionController<Movie>, MenuItem.OnMenuItemClickListener {

    //region Constants

    /**
     * Holds a constant for the {@link com.ohadshai.movielib.loaders.PopularMoviesLoader} loader id.
     */
    private static final int POPULAR_MOVIES_LOADER_ID = 173212;
    ...
    /**
     * Initializes a new instance of simple {@link Fragment} subclass for "Popular Movies".
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.popular_movies_fragment_title);
        ...
        _revealSearch = RevealHelper.create(getActivity(), flSearchContainer, "_revealSearch_PopularMovies", new RevealHelper.RevealHelperCallback() {
            @Override
        ...
        _revealSelection = RevealHelper.create(getActivity(), _toolbarSelection, "_revealSelection_PopularMovies", new RevealHelper.RevealHelperCallback() {
            @Override
            public void onReveal() {
            ...
            public void initLayoutControls() {
                ...
                actionShare.setOnMenuItemClickListener(PopularMoviesFragment.this);
                ...
                actionSelectAll.setOnMenuItemClickListener(PopularMoviesFragment.this);
    ...
    /**
     * Loads the "Popular Movies" list from the TMDB service.
     */
    public void loadPopularMoviesList() {
        getLoaderManager().initLoader(POPULAR_MOVIES_LOADER_ID, null, new LoaderManager.LoaderCallbacks<ArrayList<Movie>>() {
            @Override
            public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
                return new PopularMoviesLoader(getContext());
            }

            @Override
            public void onLoadFinished(Loader<ArrayList<Movie>> loader, ArrayList<Movie> data) {
                if (data == null) {
                    Exception exception = ((PopularMoviesLoader) loader).getException();
                    if (exception != null) {
                ...
                for (Movie movie : data)
                    _movies.add(movie);
                sort(SortAndFilterDialog.getSortFromPreferences(_preferences, UIConsts.Keys.SORT_POPULAR_MOVIES_KEY, _sorts, DEFAULT_SORT_INDEX),
                        SortAndFilterDialog.getSortOrderFromPreferences(_preferences, UIConsts.Keys.SORT_POPULAR_MOVIES_KEY, DEFAULT_SORT_ORDER_IS_ASC));
                _adapter.notifyDataSetChanged();
                displayListState();
            }
    ...
    private void actionSortAndFilter() {
        SortAndFilterDialog.show(getActivity().getFragmentManager(), UIConsts.Keys.SORT_POPULAR_MOVIES_KEY, _sorts, DEFAULT_SORT_INDEX, DEFAULT_SORT_ORDER_IS_ASC, new SortAndFilterDialog.ResultListener() {
            @Override
