...
import com.ohadshai.movielib.loaders.UpcomingMoviesLoader;
...
/**
 * A simple {@link Fragment} subclass for "Upcoming Movies".
 */
public class UpcomingMoviesFragment extends Fragment implements SelectionHelper.SelectionController<Movie>, MenuItem.OnMenuItemClickListener {

    //region Constants

    /**
     * Holds a constant for the {@link com.ohadshai.movielib.loaders.UpcomingMoviesLoader} loader id.
     */
    private static final int UPCOMING_MOVIES_LOADER_ID = 173213;
    ...
    /**
     * Initializes a new instance of simple {@link Fragment} subclass for "Upcoming Movies".
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.upcoming_movies_fragment_title);
        ...
        ((FloatingActionButton) getActivity().findViewById(R.id.fabAdd)).hide();
        ...
        _revealSearch = RevealHelper.create(getActivity(), flSearchContainer, "_revealSearch_UpcomingMovies", new RevealHelper.RevealHelperCallback() {
            @Override
        ...
        _revealSelection = RevealHelper.create(getActivity(), _toolbarSelection, "_revealSelection_UpcomingMovies", new RevealHelper.RevealHelperCallback() {
            @Override
            public void onReveal() {
            ...
            public void initLayoutControls() {
                ...
                actionShare.setOnMenuItemClickListener(UpcomingMoviesFragment.this);
                ...
                actionSelectAll.setOnMenuItemClickListener(UpcomingMoviesFragment.this);
    ...
    /**
     * Loads the "Upcoming Movies" list from the TMDB service.
     */
    public void loadUpcomingMoviesList() {
        getLoaderManager().initLoader(UPCOMING_MOVIES_LOADER_ID, null, new LoaderManager.LoaderCallbacks<ArrayList<Movie>>() {
            @Override
            public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
                return new UpcomingMoviesLoader(getContext());
            }

            @Override
            public void onLoadFinished(Loader<ArrayList<Movie>> loader, ArrayList<Movie> data) {
                if (data == null) {
                    Exception exception = ((UpcomingMoviesLoader) loader).getException();
                    if (exception != null) {
                ...
                for (Movie movie : data)
                    _movies.add(movie);
                sort(SortAndFilterDialog.getSortFromPreferences(_preferences, UIConsts.Keys.SORT_UPCOMING_MOVIES_KEY, _sorts, DEFAULT_SORT_INDEX),
                        SortAndFilterDialog.getSortOrderFromPreferences(_preferences, UIConsts.Keys.SORT_UPCOMING_MOVIES_KEY, DEFAULT_SORT_ORDER_IS_ASC));
                _adapter.notifyDataSetChanged();
                displayListState();
            }
    ...
    private void actionSortAndFilter() {
        SortAndFilterDialog.show(getActivity().getFragmentManager(), UIConsts.Keys.SORT_UPCOMING_MOVIES_KEY, _sorts, DEFAULT_SORT_INDEX, DEFAULT_SORT_ORDER_IS_ASC, new SortAndFilterDialog.ResultListener() {
            @Override
