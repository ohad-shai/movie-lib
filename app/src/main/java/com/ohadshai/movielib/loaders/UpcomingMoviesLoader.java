...
/**
 * Represents a loader for the "Upcoming Movies" list.
 * Created by Ohad on 03/21/2017.
 */
public class UpcomingMoviesLoader extends AsyncTaskLoader<ArrayList<Movie>> {
    ...
    /**
     * Initializes a new instance of a loader for the "Upcoming Movies" list.
     *
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        String url = TMDBService.Urls.GET_UPCOMING_MOVIES +
