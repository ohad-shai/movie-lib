...
/**
 * Represents a loader for the "In Theaters" list.
 * Created by Ohad on 03/21/2017.
 */
public class InTheatersLoader extends AsyncTaskLoader<ArrayList<Movie>> {
    ...
    /**
     * Initializes a new instance of a loader for the "In Theaters" list.
     *
     * @param context The context owner.
     */
    public InTheatersLoader(Context context) {
        super(context);
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        String url = TMDBService.Urls.GET_NOW_PLAYING_MOVIES +
