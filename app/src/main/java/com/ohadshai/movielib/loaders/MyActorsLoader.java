...
/**
 * Represents a loader for the "My Actors" list.
 * Created by Ohad on 03/20/2017.
 */
public class MyActorsLoader extends AsyncTaskLoader<ArrayList<Person>> {
    ...
    /**
     * Initializes a new instance of a loader for the "My Actors" list.
     *
     * @param context The context owner.
     */
    public MyActorsLoader(Context context) {
        super(context);
    ...
    public ArrayList<Person> loadInBackground() {
        return _repository.people.getAllMyActors();
    }
